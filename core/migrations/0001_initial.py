...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_restaurantmenus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('restaurant', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Restaurant'], unique=True)),
        ...
        db.create_table('core_reviewdietary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('review', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Review'], unique=True)),
    ...
    models = {
        ...
        'core.restaurantmenus': {
            ...
            'restaurant': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Restaurant']", 'unique': 'True'}),
        ...
        'core.reviewdietary': {
            ...
            'review': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Review']", 'unique': 'True'}),
