...
$.fn.rating = function(starType) {
	...
	var checkedRadio = $(container).children('input:checked')
	...
	// On page refresh, take 'checked' values and display correct number of stars
	var rate = $(checkedRadio).val();
	$(container).css('background-position', BG[rate]);
